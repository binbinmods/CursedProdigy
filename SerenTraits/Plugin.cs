...
using UnityEngine;
using System;
using static CursedProdigy.Traits;
...
namespace CursedProdigy
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Seren";
        public static string subclassName = "CursedProdigy"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Seren, the Cursed Prodigy",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/CursedProdigy",
                _contentFolder: "Seren",
